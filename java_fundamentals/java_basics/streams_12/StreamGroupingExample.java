...
public class StreamGroupingExample {
    ...
    public static void main(String[] args) {
        ...
        // Group proteins by their type
        Map<ProteinType, List<Protein>> groupedProteins = proteins.stream()
                .collect(Collectors.groupingBy(Protein::getType));

        // Print the collected data
        groupedProteins.forEach((type, proteinList) -> {
            System.out.println(type + ": " + proteinList.size() + " proteins");
            proteinList.forEach(System.out::println);
            System.out.println();
        });
    }
}
